...
saveGameDataToGoogleSheets ()
{
    const googleScriptURL =
        'https://script.google.com/macros/s/AKfycbzCu96YczR1rFZfsYeeiJ5l_d3wgNOa0R3h5igmsLxM2ho-n-NjXWCyc94cAo3JMBZLkA/exec';
    ...
    createAnswerButton (centerX, centerY, label, variableName)
{
    ...
    button.on('pointerdown', () => {
        ...
        const addNext = (callback, y = 675) => {
            this.currentNextButton = this.add.rectangle(
                640,
                y,
                160,
                55,
        ...
        {
            addNext(() => this.showHardWorkReminderScreen(), 690);
        }
